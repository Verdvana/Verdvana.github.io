...
module csr_stats_init #(
    ...
    //========================================================================
    // Init FSM: IDLE → INIT_FREE_LIST → CLEAR_QUEUE_PTR → CLEAR_COUNTER → DONE
    //   仅接口/骨架版本; 触发 LLE 建空闲链 + 初始化期清指针/计数器, 完成后置
    //   init_done。详细 FSM 状态机在详细设计阶段补充。
    //========================================================================
    // (Init FSM 逻辑详细设计阶段补充: 驱动 init_build_req / clr_ptr_cnt / init_done)
