...
![Peek FIFO directed case 1~9 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/peek_fifo_case_1_9.png)
...
![Peek FIFO random case 10 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/peek_fifo_case_10.png)

#### 7.4.3 Performance Case：测试场景 11

| 编号 | 测试场景 | 主要激励 | 期望结果 |
| --- | --- | --- | --- |
| 11 | Sustained simultaneous push/pop / 持续同周期 push-pop 性能统计 | 先根据 case10 结束后的 FIFO occupancy 做归一化：如果高于半满则连续 `pop()` drain 到半满，如果低于半满则连续 `push()` 预填充到半满；随后连续 `perf_cycles = 1000` 轮保持 `push_en = 1`、`pop_en = 1`，并统计 `perf_push_accept`、`perf_pop_accept`、`perf_full_stall` 和 `perf_empty_stall` | performance 主循环从半满稳定状态开始；每轮后 `check_state()` 仍通过；最终打印 `push_tput = perf_push_accept / perf_cycles` 和 `pop_tput = perf_pop_accept / perf_cycles`，用于观察持续 push/pop 场景下的吞吐率 |
...
![Peek FIFO performance case 11 起始阶段 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/peek_fifo_case_11_begin.png)
...
![Peek FIFO performance case 11 结束阶段 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/peek_fifo_case_11_end.png)
...
![异步FIFO case 1~3 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/async_fifo_case_1_3.png)

&#160; &#160; &#160; &#160; 下图为异步 FIFO case 4 的仿真波形，先对 FIFO 进行预填充，然后让读侧以更快节奏追赶，重点观察读写指针跨域同步后数据仍按写入顺序读出。

![异步FIFO case 4 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/async_fifo_case_4.png)
...
![异步FIFO case 5~6 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/async_fifo_case_5_6.png)
...
![异步FIFO case 7 Verdi波形](https://raw.githubusercontent.com/Verdvana/Verdvana.github.io/master/_posts/FIFO基础与CDC设计/async_fifo_case_7.png)
