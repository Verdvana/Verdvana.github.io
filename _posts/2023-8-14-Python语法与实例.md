...
&#160; &#160; &#160; &#160; Python可以使用引号（'）、双引号（"）、三引号（'''或"""）来表示字符串。引号的开始和结束必须是相同类型的。其中三引号用于多行字符标注：
...
&#160; &#160; &#160; &#160; 上述代码会一直打印“无限循环”，可以使用CTRL+C来退出无限循环。
...
&#160; &#160; &#160; &#160; 其中的执行语句2用于在循环结束后执行一段代码。

&#160; &#160; &#160; &#160; break语句可以跳出当前循环体，且**不会执行else子句**：
...
#### 5.5.3 break和continue语句及循环中的else子句

&#160; &#160; &#160; &#160; 和其它编程语句类似，break语句可以跳出for和while的循环体且任何对应的循环else块将不执行。continue语句被用来跳过当前循环块中的剩余语句，然后继续进行下一轮循环。
...
&#160; &#160; &#160; &#160; Python3.10增加了match...case的条件判断，不需要一连串的if-else了。类似C的case语句。
...
&#160; &#160; &#160; &#160; 与C、Perl、Tcl等类似，Python也可以构造函数。

### 6.1 


帮我写一个python3脚本，能够从xls或xlsx表格中获取数据，具体情况如下。表格通过命令输入。首先从名为pt或sync的sheet中获取如下数据：以ptsheet为例：内容为Signal Driving Cell的单元格右边的第一个单元格的内容存入pt.signal_driving_cell.name，右边第二个单元格的内容存入pt.signal_driving_cell.output，右边第三个单元格的内容存入pt.signal_driving_cell.input，右边第四个单元格的内容存入pt.signal_driving_cell.lib_name；内容为Clock driving Cell的单元格右边的第一个单元格的内容存入pt.clock_driving_cell.name，右边第二个单元格的内容存入pt.clock_driving_cell.output，右边第三个单元格的内容存入pt.clock_driving_cell.input，右边第四个单元格的内容存入pt.clock_driving_cell.lib_name；Signal Transition右边第一个单元格的内容存入pt.signal_trans.min，右边第二个单元格内容存入pt.signal_trans.max；Output Load右边第一个单元格的内容存入pt.output_load.min，右边第二个单元格内容存入pt.output_load.max；Setup Matgin右边第一个单元格内容存入pt.setup_margin；Hold Margin（ns）右边第一个单元内容存入pt.hold_margin；与Clock Tree Budget同为一列且在其下边的单元格内容为SM的右边第一个单元格内容存入pt.ctb.sm.source.min，右边第二个单元格存入pt.ctb.sm.source.max，右边第三个单元格存入pt.ctb.sm.network.min，右边第四个单元格存入pt.ctb.sm.network.max，右边第五个单元格存入pt.ctb.sm.trans.min，右边第六个单元格存入pt.ctb.sm.trans.max，右边第七个单元格存入pt.ctb.sm.skew，右边第八个单元格存入pt.ctb.sm.noise。名为sync的sheet格式一样，同理。名为clock的sheet要从最左侧单元格内容为Level的下一行开始读取，每一行的左侧十个单元格作为一个list，以此类推。请只用pandas和sys包来完成。


```
module Mem_Compare2(
	input	wire	[7:0]									mem1[128],	// 
	input	wire	[7:0]									mem2[128],	// 
	output	logic	[7:0]									matched_data,
	output	logic	[6:0]									matched_addr,
	output	logic											matched_found
);
	...
	//=========================================================================
	// 
	wire hit0 = (mem1[0] == mem2[0]);
	wire hit1 = (mem1[1] == mem2[1]);
	wire hit2 = (mem1[2] == mem2[2]);
	wire hit3 = (mem1[3] == mem2[3]);
	wire hit4 = (mem1[4] == mem2[4]);
	wire hit5 = (mem1[5] == mem2[5]);
	wire hit6 = (mem1[6] == mem2[6]);
	wire hit7 = (mem1[7] == mem2[7]);
	wire hit8 = (mem1[8] == mem2[8]);
	wire hit9 = (mem1[9] == mem2[9]);
	wire hit10 = (mem1[10] == mem2[10]);
	wire hit11 = (mem1[11] == mem2[11]);
	wire hit12 = (mem1[12] == mem2[12]);
	wire hit13 = (mem1[13] == mem2[13]);
	wire hit14 = (mem1[14] == mem2[14]);
	wire hit15 = (mem1[15] == mem2[15]);
	wire hit16 = (mem1[16] == mem2[16]);
	wire hit17 = (mem1[17] == mem2[17]);
	wire hit18 = (mem1[18] == mem2[18]);
	wire hit19 = (mem1[19] == mem2[19]);
	wire hit20 = (mem1[20] == mem2[20]);
	wire hit21 = (mem1[21] == mem2[21]);
	wire hit22 = (mem1[22] == mem2[22]);
	wire hit23 = (mem1[23] == mem2[23]);
	wire hit24 = (mem1[24] == mem2[24]);
	wire hit25 = (mem1[25] == mem2[25]);
	wire hit26 = (mem1[26] == mem2[26]);
	wire hit27 = (mem1[27] == mem2[27]);
	wire hit28 = (mem1[28] == mem2[28]);
	wire hit29 = (mem1[29] == mem2[29]);
	wire hit30 = (mem1[30] == mem2[30]);
	wire hit31 = (mem1[31] == mem2[31]);
	wire hit32 = (mem1[32] == mem2[32]);
	wire hit33 = (mem1[33] == mem2[33]);
	wire hit34 = (mem1[34] == mem2[34]);
	wire hit35 = (mem1[35] == mem2[35]);
	wire hit36 = (mem1[36] == mem2[36]);
	wire hit37 = (mem1[37] == mem2[37]);
	wire hit38 = (mem1[38] == mem2[38]);
	wire hit39 = (mem1[39] == mem2[39]);
	wire hit40 = (mem1[40] == mem2[40]);
	wire hit41 = (mem1[41] == mem2[41]);
	wire hit42 = (mem1[42] == mem2[42]);
	wire hit43 = (mem1[43] == mem2[43]);
	wire hit44 = (mem1[44] == mem2[44]);
	wire hit45 = (mem1[45] == mem2[45]);
	wire hit46 = (mem1[46] == mem2[46]);
	wire hit47 = (mem1[47] == mem2[47]);
	wire hit48 = (mem1[48] == mem2[48]);
	wire hit49 = (mem1[49] == mem2[49]);
	wire hit50 = (mem1[50] == mem2[50]);
	wire hit51 = (mem1[51] == mem2[51]);
	wire hit52 = (mem1[52] == mem2[52]);
	wire hit53 = (mem1[53] == mem2[53]);
	wire hit54 = (mem1[54] == mem2[54]);
	wire hit55 = (mem1[55] == mem2[55]);
	wire hit56 = (mem1[56] == mem2[56]);
	wire hit57 = (mem1[57] == mem2[57]);
	wire hit58 = (mem1[58] == mem2[58]);
	wire hit59 = (mem1[59] == mem2[59]);
	wire hit60 = (mem1[60] == mem2[60]);
	wire hit61 = (mem1[61] == mem2[61]);
	wire hit62 = (mem1[62] == mem2[62]);
	wire hit63 = (mem1[63] == mem2[63]);
	wire hit64 = (mem1[64] == mem2[64]);
	wire hit65 = (mem1[65] == mem2[65]);
	wire hit66 = (mem1[66] == mem2[66]);
	wire hit67 = (mem1[67] == mem2[67]);
	wire hit68 = (mem1[68] == mem2[68]);
	wire hit69 = (mem1[69] == mem2[69]);
	wire hit70 = (mem1[70] == mem2[70]);
	wire hit71 = (mem1[71] == mem2[71]);
	wire hit72 = (mem1[72] == mem2[72]);
	wire hit73 = (mem1[73] == mem2[73]);
	wire hit74 = (mem1[74] == mem2[74]);
	wire hit75 = (mem1[75] == mem2[75]);
	wire hit76 = (mem1[76] == mem2[76]);
	wire hit77 = (mem1[77] == mem2[77]);
	wire hit78 = (mem1[78] == mem2[78]);
	wire hit79 = (mem1[79] == mem2[79]);
	wire hit80 = (mem1[80] == mem2[80]);
	wire hit81 = (mem1[81] == mem2[81]);
	wire hit82 = (mem1[82] == mem2[82]);
	wire hit83 = (mem1[83] == mem2[83]);
	wire hit84 = (mem1[84] == mem2[84]);
	wire hit85 = (mem1[85] == mem2[85]);
	wire hit86 = (mem1[86] == mem2[86]);
	wire hit87 = (mem1[87] == mem2[87]);
	wire hit88 = (mem1[88] == mem2[88]);
	wire hit89 = (mem1[89] == mem2[89]);
	wire hit90 = (mem1[90] == mem2[90]);
	wire hit91 = (mem1[91] == mem2[91]);
	wire hit92 = (mem1[92] == mem2[92]);
	wire hit93 = (mem1[93] == mem2[93]);
	wire hit94 = (mem1[94] == mem2[94]);
	wire hit95 = (mem1[95] == mem2[95]);
	wire hit96 = (mem1[96] == mem2[96]);
	wire hit97 = (mem1[97] == mem2[97]);
	wire hit98 = (mem1[98] == mem2[98]);
	wire hit99 = (mem1[99] == mem2[99]);
	wire hit100 = (mem1[100] == mem2[100]);
	wire hit101 = (mem1[101] == mem2[101]);
	wire hit102 = (mem1[102] == mem2[102]);
	wire hit103 = (mem1[103] == mem2[103]);
	wire hit104 = (mem1[104] == mem2[104]);
	wire hit105 = (mem1[105] == mem2[105]);
	wire hit106 = (mem1[106] == mem2[106]);
	wire hit107 = (mem1[107] == mem2[107]);
	wire hit108 = (mem1[108] == mem2[108]);
	wire hit109 = (mem1[109] == mem2[109]);
	wire hit110 = (mem1[110] == mem2[110]);
	wire hit111 = (mem1[111] == mem2[111]);
	wire hit112 = (mem1[112] == mem2[112]);
	wire hit113 = (mem1[113] == mem2[113]);
	wire hit114 = (mem1[114] == mem2[114]);
	wire hit115 = (mem1[115] == mem2[115]);
	wire hit116 = (mem1[116] == mem2[116]);
	wire hit117 = (mem1[117] == mem2[117]);
	wire hit118 = (mem1[118] == mem2[118]);
	wire hit119 = (mem1[119] == mem2[119]);
	wire hit120 = (mem1[120] == mem2[120]);
	wire hit121 = (mem1[121] == mem2[121]);
	wire hit122 = (mem1[122] == mem2[122]);
	wire hit123 = (mem1[123] == mem2[123]);
	wire hit124 = (mem1[124] == mem2[124]);
	wire hit125 = (mem1[125] == mem2[125]);
	wire hit126 = (mem1[126] == mem2[126]);
	wire hit127 = (mem1[127] == mem2[127]);
 
	assign matched_data = hit0 ? mem1[0] :
                      hit1 ? mem1[1] :
                      hit2 ? mem1[2] :
                      hit3 ? mem1[3] :
                      hit4 ? mem1[4] :
	...
	assign matched_found = hit0 || hit1 || hit2 || hit3 || hit4 || hit5 || hit6 || hit7 || hit8 || hit9 ||
						   ...
						   hit40 || hit41 || hit42 || hit43 || hit44 || hit45 || hit46 || hit47 || hit48 || hit49 ||
						   hit50 || hit51 || hit52 || hit53 || hit54 || hit55 || hit56 || hit57 || hit58 || hit59 ||
						   hit60 || hit61 || hit62 || hit63 || hit64 || hit65 || hit66 || hit67 || hit68 || hit69 ||
						   hit70 || hit71 || hit72 || hit73 || hit74 || hit75 || hit76 || hit77 || hit78 || hit79 ||
						   hit80 || hit81 || hit82 || hit83 || hit84 || hit85 || hit86 || hit87 || hit88 || hit89 ||
						   hit90 || hit91 || hit92 || hit93 || hit94 || hit95 || hit96 || hit97 || hit98 || hit99 ||
						   hit100 || hit101 || hit102 || hit103 || hit104 || hit105 || hit106 || hit107 || hit108 || hit109 ||
						   hit110 || hit111 || hit112 || hit113 || hit114 || hit115 || hit116 || hit117 || hit118 || hit119 ||
						   hit120 || hit121 || hit122 || hit123 || hit124 || hit125 || hit126 || hit127;
